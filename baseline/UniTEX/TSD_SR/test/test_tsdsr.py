...
def parse_args():
    ...
    parser.add_argument("--pretrained_model_name_or_path", type=str, default="/mnt/jfs/algo/app/stabilityai/stable-diffusion-3-medium-diffusers/", help='path to the pretrained sd3')
    parser.add_argument("--lora_dir", type=str, default="/mnt/jfs/wangzihao/Projects/TSD-SR/checkpoint/tsdsr/", help='path to tsd-sr lora weights')
    parser.add_argument("--embedding_dir", type=str, default="/mnt/jfs/wangzihao/Projects/TSD-SR/dataset/default", help='path to prompt embeddings')
